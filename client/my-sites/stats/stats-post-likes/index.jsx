...
import { isRequestingPostLikes, getPostLikes } from 'state/selectors';

export const PostLikes = ( { isRequesting, likes, opened, postId, siteId, toggle, translate } ) => {
		...
		<Card className={ classNames( 'stats-module', 'stats-post-likes', 'is-expanded', classes ) }>
			...
			<div className="module-header">
				<h4 className="module-header-title">
					...
					{ likes && <Count count={ likes.length } /> }
				</h4>
			...
			{ likes && ! likes.length && ! isRequesting &&
				<div className="stats-post-likes__content">
